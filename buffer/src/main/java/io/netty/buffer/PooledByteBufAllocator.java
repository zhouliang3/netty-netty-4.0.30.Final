...
public class PooledByteBufAllocator extends AbstractByteBufAllocator {
     ...
     * @param nHeapArena
     * @param nDirectArena
     * @param pageSize inote 页大小可以通过PooledByteBufAllocator构造子中的pageSize传入，或者通过系统变量io.netty.allocator.pageSize设置，
     * 默认8192即8K，这个pageSize大小不是随意设置是有限制的，它必须大于4096（4K），而且为了方便的支持位运算使内存分配更高效，它必须是2的整数次幂。
     * @param maxOrder inote maxOrder可以通过PooledByteBufAllocator构造子的maxOrder参数或io.netty.allocator.maxOrder系统变量设置，只能设置0-14范围内的值，默认值11
     * @param tinyCacheSize
    ...
    public PooledByteBufAllocator(boolean preferDirect, int nHeapArena, int nDirectArena, int pageSize, int maxOrder,
        ...
        /**
         * inote chunkSize它是通过pageSize和maxOrder参数计算而来，计算公式是chunkSize=pageSize*（2的maxOrder次幂）,
         * 也就是说一个chunk大小默认等于2的11次方个page，chunkSize的计算方法可以查看PooledByteBufAllocator的validateAndCalculateChunkSize方法代码
         */
