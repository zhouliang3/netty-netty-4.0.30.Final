...
public final class ChannelOutboundBuffer {
    ...
    private void incrementPendingOutboundBytes(long size, boolean invokeLater) {
        ...
        /**
         * idoubt 累加本次msg的大小。如果新的totalPendingSize超过了channel的高水位线writeBufferHighWaterMark（默认值为64 * 1024），
    ...
    private void decrementPendingOutboundBytes(long size, boolean invokeLater, boolean notifyWritability) {
        ...
        /**
         * inote 更新ChannelOutBoundBuffer中待发送的msg大小totalPendingSize，并判断如果totalPendingSize小于channel的低水位线，
         * 则设置channel为可写，并触发ChannelWritabilityChanged事件。
         */
        long newWriteBufferSize = TOTAL_PENDING_SIZE_UPDATER.addAndGet(this, -size);
    ...
    public boolean remove() {
        ...
        if (!e.cancelled) {
            ...
            safeSuccess(promise);
            decrementPendingOutboundBytes(size, false, true);//inote explained is
        }
